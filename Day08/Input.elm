...
parseInstruction str =
    case String.words str of
        [ "rect", dimensions ] ->
            parseRect dimensions

        [ "rotate", cmd, direction, "by", steps ] ->
            parseRotate cmd direction steps
...
parseRect dimensions =
    case String.split "x" dimensions of
        [ a, b ] ->
            Maybe.map2 Rect (String.toInt a) (String.toInt b)

        _ ->
            Nothing


parseRotate : String -> String -> String -> Maybe Instruction
parseRotate cmd direction steps =
    case cmd of
        "row" ->
            Maybe.map2 Row (String.toInt <| String.dropLeft 2 direction) (String.toInt steps)

        "column" ->
            Maybe.map2 Column (String.toInt <| String.dropLeft 2 direction) (String.toInt steps)
